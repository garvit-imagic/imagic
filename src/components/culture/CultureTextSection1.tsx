...
export default function CultureTextSection1() {
  ...
  return (
    <section className="w-full">
      {/* Desktop Version */}
      <div className="hidden md:block mx-[100px] mt-[145px]">
        {/* Row 1 - "Serious about design" */}
        <div className="mb-[189px] text-left">
          <div className="leading-[100%]">
            <span className="font-bold text-[96px] tracking-[0%]">
              {section1.row1.line1}
            </span>
          </div>
          <div className="leading-[100%]">
            <span className="font-normal text-[96px] tracking-[0%]">
        ...
        {/* Row 2 - Paragraphs */}
        <div className="mb-[334px] text-right">
          <p className="font-normal text-[32px] leading-[100%] tracking-[0%]">
            {section1.row2.paragraph1}
            <span className="italic">{section1.row2.italicText}</span>
          </p>
          <p className="font-normal text-[32px] leading-[100%] tracking-[0%] mt-4">
