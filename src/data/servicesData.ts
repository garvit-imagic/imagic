export const servicesIntroTexts = [
  {
    ...
    width: "40%",
    className: "font-normal text-[32px] leading-[130%] tracking-[0%]",
    marginBottom: "mb-[200px]",
    textAlign: "text-left",
    delay: 0.5,
    // Mobile overrides
    mobileWidth: "90%",
    mobileClassName: "font-normal text-[18px] leading-[130%] tracking-[0%]",
...
export const serviceHeading = {
  ...
  mainHeadingClassName: "font-bold text-[24px] leading-[130%] tracking-[0%]",
...
export const serviceDetailCards = [
  {
    ...
    column1: {
      ...
      headingClassName: "font-normal text-[36px] leading-[130%] tracking-[0%]",
      description:
        "Defining your brand's story, voice, and messaging so it connects with the right audiences.",
      descriptionClassName:
        "font-normal text-[24px] leading-[130%] tracking-[0%] pl-[62px]",
      // Mobile
      mobileHeadingClassName:
        "font-normal text-[22px] leading-[130%] tracking-[0%] text-center",
      mobileDescriptionClassName:
        "font-normal text-[16px] leading-[130%] tracking-[0%] text-center pl-0",
    },
    column2: {
      ...
      pointerClassName: "font-normal text-[24px] leading-[130%] tracking-[0%]",
      numberTextGap: "gap-[8px]",
      // Mobile
      mobileHeadingClassName:
        "font-normal text-[22px] leading-[130%] tracking-[0%] text-center",
      mobilePointerClassName:
        "font-normal text-[16px] leading-[130%] tracking-[0%] text-center",
    },
  },
  {
...
export const servicesClosingText = {
  ...
  className: "font-bold text-[40px] leading-[130%] tracking-[0%] text-center",
  containerClassName: "w-[90%] mx-auto",
  // Mobile
  mobileClassName:
    "font-bold text-[24px] leading-[130%] tracking-[0%] text-center",
...
export const servicesDetailTable = {
  ...
  rowClassName:
    "font-normal text-[24px] leading-[130%] tracking-[0%] pb-[22px]",
  ...
  mobileRowClassName:
    "font-normal text-[16px] leading-[130%] tracking-[0%] py-[15px] border-b border-gray-300 text-center",
};
